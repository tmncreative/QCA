...
function Logo({size=48}){
  return(<svg width={size} height={size*1.1} viewBox="0 0 100 110">
    <path d="M50 5 L90 27.5 L90 72.5 L50 95 L10 72.5 L10 27.5 Z" fill={C.teal}/>
    <path d="M10 72.5 L10 98 L28 98 L10 72.5Z" fill={C.teal}/>
    <path d="M50 15 L82 33 L82 67 L50 85 L18 67 L18 33 Z" fill={C.white}/>
    <path d="M50 22 L76 37 L76 63 L50 78 L24 63 L24 37 Z" fill="none" stroke={C.green} strokeWidth="5"/>
    <path d="M57 57 C57 61 54 64 51 64 C48 64 45 61 45 57 C45 53 51 46 51 46 C51 46 57 53 57 57Z" fill={C.teal}/>
  </svg>);
}
...
function HeroBG(){
  return(<div style={{position:"absolute",inset:0,overflow:"hidden",pointerEvents:"none"}}>
    ...
    <div style={{position:"absolute",right:"8%",top:"5%",width:1,height:"90%",background:`linear-gradient(180deg,transparent,${C.green}18,transparent)`,transform:"rotate(-12deg)"}}/>
    <div style={{position:"absolute",left:"15%",top:"10%",width:1,height:"70%",background:`linear-gradient(180deg,transparent,${C.teal}12,transparent)`,transform:"rotate(-8deg)"}}/>
    ...
    <nav style={{position:"fixed",top:0,left:0,right:0,zIndex:1000,padding:scrolled?"10px 0":"16px 0",background:scrolled?"rgba(12,47,61,.97)":"transparent",backdropFilter:scrolled?"blur(16px)":"none",transition:"all .35s",borderBottom:scrolled?`1px solid rgba(0,212,85,.1)`:"none"}}>
      <div style={{maxWidth:1200,margin:"0 auto",padding:"0 24px",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
        <div onClick={()=>go("Home")} style={{cursor:"pointer",display:"flex",alignItems:"center",gap:10}}>
          <Logo size={30}/><span style={{fontFamily:F.h,fontSize:19,fontWeight:700,color:C.white}}>QC Atlantic</span>
        </div>
...
function Footer(){
  return(<footer style={{background:C.dark,padding:"44px 24px 28px",borderTop:`1px solid rgba(0,212,85,.06)`}}>
    <div className="m-pad" style={{maxWidth:1200,margin:"0 auto",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:14}}>
      <div style={{display:"flex",alignItems:"center",gap:10}}><Logo size={26}/><span style={{fontFamily:F.h,fontSize:15,fontWeight:700,color:C.white}}>QC Atlantic</span></div>
