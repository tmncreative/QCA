...
function HeroBG(){
  return(<div style={{position:"absolute",inset:0,overflow:"hidden",pointerEvents:"none"}}>
    ...
    <img src="/logo-w.png" alt="" style={{position:"absolute",left:"50%",top:"18%",transform:"translateX(-50%)",width:"clamp(400px,55vw,700px)",height:"auto",opacity:.04,pointerEvents:"none",userSelect:"none"}}/>
  </div>);
}
