...
function HeroBG(){
  return(<div style={{position:"absolute",inset:0,overflow:"hidden",pointerEvents:"none"}}>
    ...
    <img src="/logo-w.png" alt="" style={{position:"absolute",right:"-6%",top:"50%",transform:"translateY(-50%)",width:"clamp(400px,55vw,700px)",height:"auto",opacity:.04,pointerEvents:"none",userSelect:"none"}}/>
  </div>);
}
